...
NSArray *PerformHTMLXPathQuery(NSData *document, NSString *query)
{
  ...
  /* Load XML document */
  /* ISO-8859-1 added to allow parsing specifically of Pelotonia web site -- used to be NULL */
  doc = htmlReadMemory([document bytes], (int)[document length], "", "ISO-8859-1", HTML_PARSE_NOWARNING | HTML_PARSE_NOERROR);
